<x-app-layout>
    <x-slot name="header">
        <div class="grid grid-cols-2">
            ...
            <div class="mx-auto">
                <a class="dark:text-white text-white bg-mulberry hover:bg-[#AF3F73] focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-md p-2 text-center dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
            ...
            <div class="w-3/4 mx-auto sm:px-6 lg:px-8 sm:rounded-lg">
                @foreach ($ads as $ad)
                    @if ($ad->ad_accepted == 0 and Auth::user() and ($ad->user_id == auth()->id() or Auth::user()->is_admin))
                        <a href="ads/{{ $ad->ad_id }}">
                            <div
                                class="bg-red-600 hover:bg-red-700  overflow-hidden grid grid-cols-2 shadow-sm sm:rounded-lg dark:bg-red-600 dark:hover:bg-red-700">
                    ...
                    @elseif ($ad->ad_accepted == 1)
                        <a href="ads/{{ $ad->ad_id }}">
                            <div
                                class="bg-jordy-blue hover:bg-ruddy-blue overflow-hidden grid grid-cols-2 shadow-sm sm:rounded-lg dark:bg-gray-800 dark:hover:bg-blue-900">
                                <div class="p-6 text-gray-900 dark:text-gray-100">
                                    <h1 class="font-semibold text-xl text-gray-800 dark:text-gray-200">
                                        {{ $ad->title }}
                                    </h1>
                    ...
                    <div class="flex justify-evenly text-center mt-2 mb-5">
                        ...
                        @endcan
                        @can('update', $ad)
                            <x-primary-button class="w-[20vw]   dark:hover:bg-ruddy-blue dark:text-black"
                                x-data=""
