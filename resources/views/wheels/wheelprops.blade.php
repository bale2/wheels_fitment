<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 sm:rounded-lg ">
            <div class="overflow-hidden shadow-sm ">
                <a href="wheel_types">
                    <div class="flex flex-row sm:rounded-lg  mb-2 bg-gray-800">
                        <?xml version="1.0" encoding="iso-8859-1"?>
                        <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
                        <svg class="my-auto ml-2" fill="#000000" height="50px" stroke-width="4" width="50px"
   ...
   C409.6,302.396,388.838,343.962,356.207,372.147z" />
                        ...
                        <div class="p-6 pl-3 text-gray-900 dark:text-gray-100 border border-yellow-400">
                ...
                <a href="bolt_patterns">
                    <div class="flex flex-row sm:rounded-lg  mb-2 bg-gray-800">
                        ...
                        <svg class="my-auto pl-3" version="1.0" xmlns="http://www.w3.org/2000/svg" width="50px"
...
-72 2 -85 0 -85 -13z" />
                ...
                <a href="nut_bolts">
                    <div class="flex flex-row sm:rounded-lg  mb-2 bg-gray-800">
                        ...
                        <svg class="my-auto ml-2" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
                            xmlns:xlink="http://www.w3.org/1999/xlink" width="50px" height="50px" x="0px" y="0px"
                            viewBox="0 0 122.87 122.88" style="enable-background:new 0 0 122.87 122.88"
                            xml:space="preserve">
                            <g>
                                <path
                        ...
                        <div class="p-6 pl-3 text-gray-900 dark:text-gray-100">
                            <h1 class="font-semibold text-xl text-gray-800 dark:text-gray-200">Nut Or Bolt</h1>
                        </div>
                    </div>
                </a>
                <a href="/manufacturers">
                    <div class="flex flex-row sm:rounded-lg  mb-2 bg-gray-800">
                        ...
                        <!-- Uploaded to: SVG Repo, www.svgrepo.com, Generator: SVG Repo Mixer Tools -->
                        <svg class="mt-2" fill="#000000" width="50px" height="50px" viewBox="0 0 56 56"
