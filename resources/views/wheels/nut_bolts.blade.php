<x-app-layout>
    <x-slot name="header">
        <div class="flex justify-around ">
            <div class="w-3 ">
                <a href="/data" ><svg fill="#000000" class="h-5 w-5" version="1.1" id="Capa_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="0 0 26.676 26.676" xml:space="preserve">
    ...
    <div class="py-12">
        ...
        <x-modal name="nut_bolt_create" :show="$errors->userDeletion->isNotEmpty()" focusable>
            <form method="post" action="{{ route('nut_bolts_create_post') }}" class="mt-2 space-y-2 flex flex-col items-center" enctype="multipart/form-data">
                ...
                @method('post')
                {{-- type --}}
                <x-input-label for="type" :value="__('Nut or Bolt')" class="dark:text-gray-200" />
