    ...
    <x-modal name="wheel_update_post" :show="$errors->userDeletion->isNotEmpty()" focusable>
        <form method="post" action="{{ route('wheel_update_post') }}" class="mt-6 space-y-6 " enctype="multipart/form-data">
            ...
            <input type="hidden" value="{{ $wheel->id }}" name="wheel_id" class="block mt-1 w-full"/>
             ...
             <x-input-label for="manufacturer_id" :value="__('manufacturer_id')" class="dark:text-gray-200" />
            <x-text-input id="manufacturer_id" name="manufacturer_id" class="field" class="dark:text-gray-200 bg-white dark:bg-gray-800"/>
            ...
            <x-text-input id="note" name="note" type="text"  class=" field dark:text-gray-200 bg-white dark:bg-gray-800"/>
