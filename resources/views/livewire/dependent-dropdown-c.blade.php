<div>
    <div class="form-group row">
        <label for="category" class="col-md-4 text-md-right dark:text-gray-200 text-black"><strong>Manufacturer
                (Wheels)</strong></label>
        <div class="col-md-6">
            ...
            <div class="col-md-6">
                ...
                <form method="post" action="{{ route('car_wheel_post') }}" enctype="multipart/form-data">
                    ...
                    <select required onChange="window.location.href=this.value"
                        class="dark:text-gray-200 bg-jordy-blue dark:bg-gray-800 border-transparent rounded-lg w-80 form-control"
                        name="wheel_id">
                        <option class="bg-jordy-blue dark:bg-gray-800" value="" selected>Choose product</option>
                        @if ($wheels)
