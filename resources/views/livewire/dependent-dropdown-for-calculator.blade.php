<div class="flex flex-row">
    <div>
        <div class="form-group row">
            ...
            <div class="col-md-6">
                <select id="man_id" wire:model.live="selectedManufacturer"
    ...
    <script>
        ...
        function change_car() {
            jsVariable = document.getElementById('car_id').value;
            jsVariable = JSON.parse(jsVariable);
            felnidistance = jsVariable.mtsurface_fender_distance;
