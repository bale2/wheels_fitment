...
class DatabaseSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        $manufacturers2 = ["Unknown", "BBS", "3SDM", "RADI8", "Ronal", "Enkei", "Vossen", "Rotiform", "OZ Racing", "Forgestar", "ADV.1", "HRE", "American Racing", "Konig", "Work Wheels", "Volk Racing", "Fifteen52", "SSR", "TSW", "Momo", "Hartge"];
        ...
        // values('1','1','elso',1,'1',11,11,11,'1','anyam',100,'1','0','anyam.png','elso wheel','2024-02-03 22:31:41', '2024-02-03 22:31:41');
        // id, manufacturer_id, model, price, wheel_type_id, diameter, width, ET_number, bolt_pattern_id, kba_number, center_bore, nut_bolt_id, multipiece, photo, note, accepted, created_at, updated_at
        Wheel::insert([
            'manufacturer_id' => 1,
            'model' => 'Unknown',
            'price' => 0,
